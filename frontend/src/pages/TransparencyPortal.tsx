    ...
    <div className="min-h-screen bg-slate-950 text-slate-50 font-sans selection:bg-cyan-500/30 overflow-x-hidden pb-12">
      ...
      <div className="bg-slate-900/80 backdrop-blur-md border-b border-slate-800 py-6 sticky top-0 z-30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              <h1 className="text-3xl font-bold text-slate-50">Public Transparency Portal</h1>
              <p className="text-slate-400 mt-1">Aggregated complaint metrics and performance indicators</p>
            </div>
            <div className="flex space-x-4">
              <button
                onClick={fetchData}
                className="px-4 py-2 bg-slate-800 border border-slate-700 text-cyan-400 hover:bg-slate-700 rounded-xl transition-colors font-medium flex items-center gap-2"
              >
              ...
              <button
                onClick={downloadCSV}
                className="px-4 py-2 bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-bold rounded-xl transition-colors flex items-center gap-2 shadow-[0_0_15px_rgba(6,182,212,0.2)]"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6 backdrop-blur-sm hover:border-slate-700 transition-colors">
            <div className="flex items-start justify-between">
              <div>
                <h3 className="text-sm font-medium text-slate-400 mb-1">Total Volume</h3>
                <p className="text-3xl font-bold text-slate-50">{formatNumber(data.totalComplaints)}</p>
              </div>
          ...
          <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6 backdrop-blur-sm hover:border-slate-700 transition-colors">
            <div className="flex items-start justify-between">
              <div>
                <h3 className="text-sm font-medium text-slate-400 mb-1">Clearance Rate</h3>
                <p className="text-3xl font-bold text-slate-50">{formatPercentage(data.resolvedRatio)}</p>
              </div>
          ...
          <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6 backdrop-blur-sm hover:border-slate-700 transition-colors">
            <div className="flex items-start justify-between">
              <div>
                <h3 className="text-sm font-medium text-slate-400 mb-1">Avg Turnaround</h3>
                <p className="text-3xl font-bold text-slate-50">{formatHours(data.avgResolutionTimeHours)}</p>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <div className="bg-slate-900/50 border border-slate-800 rounded-2xl backdrop-blur-sm overflow-hidden flex flex-col">
            <div className="p-6 border-b border-slate-800">
              <h2 className="text-lg font-semibold text-slate-50">Department Breakdown</h2>
            </div>
          ...
          <div className="bg-slate-900/50 border border-slate-800 rounded-2xl backdrop-blur-sm overflow-hidden flex flex-col">
            <div className="p-6 border-b border-slate-800">
              <h2 className="text-lg font-semibold text-slate-50">Zone Distribution</h2>
            </div>
            <div className="overflow-x-auto flex-1">
              <table className="min-w-full divide-y divide-slate-800">
                <thead className="bg-slate-950/50">
