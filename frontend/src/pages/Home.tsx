...
const Home = () => {
  return (
    <div className="relative flex-1 bg-slate-950 text-slate-50 font-sans selection:bg-cyan-500/30">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32 flex flex-col gap-24">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative w-full h-[500px] hidden md:block">
            {/* Card 1: Main Status */}
            <div className="absolute top-10 right-10 w-72 bg-white/5 backdrop-blur-xl border border-slate-700/50 p-6 rounded-2xl shadow-2xl z-20">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-xs font-semibold text-emerald-400 bg-emerald-400/10 px-2 py-1 rounded">Resolved</span>
              </div>
            ...
            <div className="absolute bottom-10 left-10 w-80 bg-slate-900/80 backdrop-blur-lg border border-slate-700/50 p-6 rounded-2xl shadow-2xl z-10">
              <div className="flex justify-between items-end mb-6">
                <div>
                  <h3 className="text-sm font-bold text-slate-400 tracking-wider uppercase">Avg Response</h3>
                  <div className="text-3xl font-extrabold text-white mt-1">1.2h</div>
                </div>
            ...
            <div className="absolute top-32 left-0 w-64 h-48 bg-white/5 backdrop-blur-md border border-slate-700/50 rounded-2xl shadow-xl z-0 transform -rotate-6"></div>
          </div>
        </section>
        ...
        <section className="mb-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-white tracking-tight">Streamlined Resolution Workflow</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 md:grid-rows-2 gap-6">
            ...
            <div className="group md:row-span-2 md:col-span-1 bg-white/5 backdrop-blur-sm border border-slate-700/50 hover:border-cyan-400/50 rounded-2xl p-8 transition-colors duration-300 flex flex-col h-full">
              ...
              <h3 className="text-xl font-bold text-white mb-3 tracking-tight">Submit Complaints</h3>
            ...
            {/* Feature 2: Top Right */}
            <div className="group md:col-span-2 bg-white/5 backdrop-blur-sm border border-slate-700/50 hover:border-cyan-400/50 rounded-2xl p-8 transition-colors duration-300 flex items-start gap-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-white mb-2 tracking-tight">Track Progress in Real-time</h3>
            ...
            <div className="group md:col-span-2 bg-white/5 backdrop-blur-sm border border-slate-700/50 hover:border-cyan-400/50 rounded-2xl p-8 transition-colors duration-300 flex items-start gap-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-white mb-2 tracking-tight">Rapid Automated Resolution</h3>
                <p className="text-slate-400 leading-relaxed">
