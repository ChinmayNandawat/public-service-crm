...
describe('Priority Score Utility', () => {
    describe('computePriorityScore', () => {
        it('should calculate correct score for high urgency, angry sentiment', () => {
            ...
            const score = (0, priorityScore_1.computePriorityScore)(input);
        ...
        it('should clamp scores to 0..1 range', () => {
            ...
            const highScore = (0, priorityScore_1.computePriorityScore)(highInput);
            ...
            const lowScore = (0, priorityScore_1.computePriorityScore)(lowInput);
...
//# sourceMappingURL=priorityScore.test.js.map