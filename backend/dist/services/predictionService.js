...
exports.predictComplaints = predictComplaints;
exports.createSampleTimeSeries = createSampleTimeSeries;
...
function calculateRiskLevel(prediction, historicalAverage) {
...
function groupComplaintsByDate(complaints, groupBy) {
...
function generateTimeSeries(groupedData, groupKey, days) {
    const series = [];
...
async function predictComplaints(complaints, options = {}) {
...
function createSampleTimeSeries() {
    return [
