...
exports.computePriorityScore = void 0;
const computePriorityScore = (input) => {
    ...
    const locationSensitivity = location && criticalAreas.some(area => location.toLowerCase().includes(area.toLowerCase())) ? 0.1 : 0;
...
//# sourceMappingURL=priorityScore.js.map